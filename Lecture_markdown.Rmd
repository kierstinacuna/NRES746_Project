...
us to change our visualization of the data. 
...
In PCA, CA and PCoA, a goal is to preserve distances among objects, yet a good portion of variation can be lost through principal component selection. 
NMDS maintains a limited number of ordination axes to keep as much of the variation of the data set while 
