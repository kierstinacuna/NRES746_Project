...
The Redundancy Analysis models the effect of an explanatory matrix on a **response matrix**. That idea is important, as we have usually only have one response varaible in our models. A summary of the technique is that an ordination is done on a response matrix **Y** to obtain ordination axes that are linear combinations of explanatory matrix **X**. 
